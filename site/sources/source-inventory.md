...
| Branding artwork, app icons and colour palette | https://www.steamgriddb.com/game/5313303 | Selected 2026-08-17 | SteamGridDB contributors Anon11926, Kam and 8resolution | Yes | Local hero, logo and source icon are credited in `assets/art/STEAMGRIDDB_CREDITS.md`; the cyan/steel/gold interface palette and dedicated iPad/PWA icon set were derived from them. |
